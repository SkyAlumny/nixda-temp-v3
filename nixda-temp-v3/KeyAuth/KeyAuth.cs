...
#pragma warning restore IDE0052
        ...
        public static DateTime UnixTimeToDate(long unixtime)
        {
            ...
            {
                return DateTime.MaxValue.Date; // Also without time component
            }
        }
        ...
        public class user_data_class
        {
            ...
            public DateTime CreationDate => KeyAuth.api.UnixTimeToDate(long.Parse(createdate));
            public DateTime LastLoginDate => KeyAuth.api.UnixTimeToDate(long.Parse(lastlogin));
        }
        public class Data
        {
            ...
            public DateTime expiration
            {
                get
                {
                    return KeyAuth.api.UnixTimeToDate(long.Parse(expiry));
                }
            }
        }
